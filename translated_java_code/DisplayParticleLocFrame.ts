...
namespace vaango_ui {
    export class DisplayParticleLocFrame extends JFrame {
        private static serialVersionUID : number = -4659212516518318851;
        ...
        private topCanvas : DisplayParticleLocFrame.TopCanvas = null;

        private sideCanvas : DisplayParticleLocFrame.SideCanvas = null;

        private frontCanvas : DisplayParticleLocFrame.FrontCanvas = null;
        ...
        public constructor(partList : ParticleList, parent : ParticleLocGeneratePanel) {
            ...
            this.setTitle("Particle Locations");
            this.d_isHollow = false;
            this.d_thickness = 0.0;
            this.d_partList = partList;
            this.d_parent = parent;
            var panel : JPanel = new JPanel(new GridLayout(2, 2));
            this.topCanvas = new DisplayParticleLocFrame.TopCanvas(this, 300, 300);
            this.sideCanvas = new DisplayParticleLocFrame.SideCanvas(this, 300, 300);
            this.frontCanvas = new DisplayParticleLocFrame.FrontCanvas(this, 300, 300);
    ...
    export namespace DisplayParticleLocFrame {
        ...
        export class PlaneCanvas extends LightWeightCanvas {
            ...
            public constructor(__parent: any, width : number, height : number, type : number) {
                ...
                this.serialVersionUID = -5023314821860674475;
                this.d_type = 0;
                this.xbuf = 0;
                this.ybuf = 0;
                this.xsmallbuf = 0;
        ...
        export class TopCanvas extends DisplayParticleLocFrame.PlaneCanvas {
            public __parent: any;
            static serialVersionUID : number;

            public constructor(__parent: any, width : number, height : number) {
                super(__parent, width, height, DisplayParticleLocFrame.TOP);
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler","java.awt.MenuContainer","java.awt.image.ImageObserver","java.io.Serializable"] });
                this.__parent = __parent;
                this.serialVersionUID = -2782466296581762181;
                this.initialize();
            }
            ...
            drawParticles(g : Graphics) {
                ...
                if(type === DisplayParticleLocFrame.CIRCLE) this.drawCircles(g, size); else if(type === DisplayParticleLocFrame.SPHERE) this.drawSpheres(g, size);
                g.drawRect(this.xmin, this.ymin, this.xmax - this.xmin, this.ymax - this.ymin);
            }
        ...
        export class SideCanvas extends DisplayParticleLocFrame.PlaneCanvas {
            public __parent: any;
            /**
             * 
             */
            ...
            public constructor(__parent: any, width : number, height : number) {
                super(__parent, width, height, DisplayParticleLocFrame.SIDE);
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler","java.awt.MenuContainer","java.awt.image.ImageObserver","java.io.Serializable"] });
                this.__parent = __parent;
                this.serialVersionUID = 6945730750216943834;
                this.initialize();
            }
            ...
            drawParticles(g : Graphics) {
                ...
                this.__parent.d_thickness = part.getThickness();
                if(this.__parent.d_thickness > 0.0) this.__parent.d_isHollow = true;
                if(type === DisplayParticleLocFrame.CIRCLE) this.drawCylinders(g, size); else if(type === DisplayParticleLocFrame.SPHERE) this.drawSpheres(g, size);
            }
        ...
        export class FrontCanvas extends DisplayParticleLocFrame.PlaneCanvas {
            public __parent: any;
            /**
             * 
             */
            ...
            public constructor(__parent: any, width : number, height : number) {
                super(__parent, width, height, DisplayParticleLocFrame.FRONT);
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler","java.awt.MenuContainer","java.awt.image.ImageObserver","java.io.Serializable"] });
                this.__parent = __parent;
                this.serialVersionUID = 5215584795809418193;
                this.initialize();
            }
