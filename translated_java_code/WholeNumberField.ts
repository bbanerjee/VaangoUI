...
namespace vaango_ui {
    ...
    export class WholeNumberField extends JTextField {
        /**
         * 
         */
        private static serialVersionUID : number = 9073779561776791173;
    ...
    export namespace WholeNumberField {

        export class WholeNumberDocument extends PlainDocument {
            public __parent: any;
            /**
             * 
             */
            ...
            constructor(__parent: any) {
                ...
                this.serialVersionUID = -8935374188934031387;
            }
        }
    }
