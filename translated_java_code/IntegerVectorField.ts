...
namespace vaango_ui {
    export class IntegerVectorField extends JPanel {
        /**
         * 
         */
        private static serialVersionUID : number = -5563228233944277430;
        ...
        private xEntry : IntegerField = null;

        private yEntry : IntegerField = null;

        private zEntry : IntegerField = null;

        public constructor(xval : number, yval : number, zval : number, columns : number) {
            super();
            ...
            this.xEntry = new IntegerField(xval, columns);
            ...
            this.yEntry = new IntegerField(yval, columns);
            ...
            this.zEntry = new IntegerField(zval, columns);
