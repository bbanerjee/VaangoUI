...
namespace vaango_ui {
    ...
    export class DisplayPartDistFrame extends JFrame {
        /**
         * 
         */
        private static serialVersionUID : number = 621234823627831119;

        private d_partSizeDist : ParticleSize = null;

        private d_parent : ParticleSizeDistInputPanel = null;

        private inputCanvas : DisplayPartDistFrame.DistribCanvas = null;

        private calcCanvas : DisplayPartDistFrame.DistribCanvas = null;

        private ballCanvas : DisplayPartDistFrame.BallCanvas = null;
        ...
        public constructor(partSizeDist : ParticleSize, parent : ParticleSizeDistInputPanel) {
            ...
            this.setTitle("Particle Size Distribution");
            ...
            this.inputCanvas = new DisplayPartDistFrame.DistribCanvas(this, 3 * canvasWidth, 3 * canvasHeight, this.INPUT);
            var calcCanvasLabel : JLabel = new JLabel("Calculated Size Distribution");
            this.calcCanvas = new DisplayPartDistFrame.DistribCanvas(this, 3 * canvasWidth, 3 * canvasHeight, this.CALC);
            var ballCanvasLabel : JLabel = new JLabel("Calculated Particle Sizes");
            this.ballCanvas = new DisplayPartDistFrame.BallCanvas(this, 6 * canvasWidth, canvasHeight);
    ...
    export namespace DisplayPartDistFrame {
        ...
        export class DistribCanvas extends LightWeightCanvas {
            ...
            public constructor(__parent: any, width : number, height : number, flag : number) {
                ...
                this.serialVersionUID = -8140739435964672419;
                this.xbuf = 0;
                this.ybuf = 0;
                this.xsmallbuf = 0;
                this.ysmallbuf = 0;
        ...
        export class BallCanvas extends LightWeightCanvas {
            ...
            public constructor(__parent: any, width : number, height : number) {
                ...
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler","java.awt.MenuContainer","java.awt.image.ImageObserver","java.io.Serializable"] });
                this.__parent = __parent;
                this.serialVersionUID = -5465706776407352728;
