...
namespace vaango_ui {
    ...
    export class DisplayGeometryPanel extends JPanel {
        /**
         * 
         */
        private static serialVersionUID : number = 6421835483312699576;

        private d_domainSize : number = 100.0;
        ...
        private topCanvas : DisplayGeometryPanel.TopCanvas = null;

        private sideCanvas : DisplayGeometryPanel.SideCanvas = null;

        private frontCanvas : DisplayGeometryPanel.FrontCanvas = null;
        ...
        public constructor(partList : ParticleList, geomPiece : Vector<GeomPiece>, parent : GeometryPanel) {
            ...
            this.topCanvas = new DisplayGeometryPanel.TopCanvas(this, 300, 300);
            this.sideCanvas = new DisplayGeometryPanel.SideCanvas(this, 300, 300);
            this.frontCanvas = new DisplayGeometryPanel.FrontCanvas(this, 300, 300);
    ...
    export namespace DisplayGeometryPanel {
        ...
        export class PlaneCanvas extends LightWeightCanvas {
            ...
            public constructor(__parent: any, width : number, height : number, type : number) {
                ...
                this.serialVersionUID = -2497974316381711414;
                this.d_type = 0;
                this.xbuf = 0;
                this.ybuf = 0;
                this.xsmallbuf = 0;
        ...
        export class TopCanvas extends DisplayGeometryPanel.PlaneCanvas {
            public __parent: any;
            /**
             * 
             */
            ...
            public constructor(__parent: any, width : number, height : number) {
                super(__parent, width, height, DisplayGeometryPanel.TOP);
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler","java.awt.MenuContainer","java.awt.image.ImageObserver","java.io.Serializable"] });
                this.__parent = __parent;
                this.serialVersionUID = -8845232394815918755;
                this.initialize();
            }
            ...
            drawParticles(g : Graphics) {
                ...
                if(type === DisplayGeometryPanel.CIRCLE) this.drawCircles(g, size); else if(type === DisplayGeometryPanel.SPHERE) this.drawSpheres(g, size);
            }
            ...
            calcArcAngle(rad : number, xCent : number, yCent : number) : number[] {
                var distXPlus : number = this.d_domainSize - xCent;
                var distYPlus : number = this.d_domainSize - yCent;
        ...
        export class SideCanvas extends DisplayGeometryPanel.PlaneCanvas {
            public __parent: any;
            /**
             * 
             */
            ...
            public constructor(__parent: any, width : number, height : number) {
                super(__parent, width, height, DisplayGeometryPanel.SIDE);
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler","java.awt.MenuContainer","java.awt.image.ImageObserver","java.io.Serializable"] });
                this.__parent = __parent;
                this.serialVersionUID = 2074511198445639756;
                this.initialize();
            }
            ...
            drawParticles(g : Graphics) {
                ...
                var part : Particle = this.__parent.d_partList.getParticle(0);
                var type : number = part.getType();
                if(type === DisplayGeometryPanel.CIRCLE) this.drawCylinders(g, size); else if(type === DisplayGeometryPanel.SPHERE) this.drawSpheres(g, size);
            }
        ...
        export class FrontCanvas extends DisplayGeometryPanel.PlaneCanvas {
            public __parent: any;
            /**
             * 
             */
            ...
            public constructor(__parent: any, width : number, height : number) {
                super(__parent, width, height, DisplayGeometryPanel.FRONT);
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler","java.awt.MenuContainer","java.awt.image.ImageObserver","java.io.Serializable"] });
                this.__parent = __parent;
                this.serialVersionUID = -4342480714593658960;
                this.initialize();
            }
