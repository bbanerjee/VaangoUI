<template>
  <div id='vaango-main-panel' 
       class="uk-container uk-container-center uk-margin-remove-top uk-margin-remove-left uk-margin-remove-right uk-margin-large-bottom"> 
    <main-menubar class="uk-child-width-1-1"> 
    </main-menubar>
    <div id="container" class="uk-flex uk-flex-around">
      <div class="uk-flex-vertical uk-flex-around">
        <sidebar
