...
class ThreeTrackball {
    ...
    getMouseOnCircle(pageX, pageY) {
        this.vector.set(((pageX - this.screen.width * 0.5 - this.screen.left) / (this.screen.width * 0.5)), ((this.screen.height + 2 * (this.screen.top - pageY)) / this.screen.width) // screen.width intentional
        );
        return this.vector;
    }
    rotateCamera() {
