...
var vaango_ui;
(function (vaango_ui) {
    var DisplayParticleLocPanel = (function (_super) {
        __extends(DisplayParticleLocPanel, _super);
        function DisplayParticleLocPanel(partList, parent) {
            ...
            _this.topCanvas = new DisplayParticleLocPanel.TopCanvas(_this, 300, 300);
            _this.sideCanvas = new DisplayParticleLocPanel.SideCanvas(_this, 300, 300);
            _this.frontCanvas = new DisplayParticleLocPanel.FrontCanvas(_this, 300, 300);
        ...
        DisplayParticleLocPanel.prototype.refresh = function () {
            this.topCanvas.refresh();
            this.sideCanvas.refresh();
            this.frontCanvas.refresh();
        };
        return DisplayParticleLocPanel;
    }(JPanel));
    /**
     *
     */
    DisplayParticleLocPanel.serialVersionUID = 2088863934509441290;
    DisplayParticleLocPanel.TOP = 1;
    DisplayParticleLocPanel.SIDE = 2;
    DisplayParticleLocPanel.FRONT = 3;
    DisplayParticleLocPanel.CIRCLE = 1;
    DisplayParticleLocPanel.SPHERE = 2;
    DisplayParticleLocPanel.YES = 1;
    DisplayParticleLocPanel.NO = 2;
    vaango_ui.DisplayParticleLocPanel = DisplayParticleLocPanel;
    (function (DisplayParticleLocPanel) {
        var PlaneCanvas = (function (_super) {
            ...
            function PlaneCanvas(__parent, width, height, type) {
                ...
                _this.serialVersionUID = 5880208123180576654;
                _this.d_type = 0;
                _this.xbuf = 0;
                _this.ybuf = 0;
                _this.xsmallbuf = 0;
        ...
        DisplayParticleLocPanel.PlaneCanvas = PlaneCanvas;
        var TopCanvas = (function (_super) {
            __extends(TopCanvas, _super);
            function TopCanvas(__parent, width, height) {
                var _this = _super.call(this, __parent, width, height, DisplayParticleLocPanel.TOP) || this;
                Object.defineProperty(_this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler", "java.awt.MenuContainer", "java.awt.image.ImageObserver", "java.io.Serializable"] });
                _this.__parent = __parent;
                _this.serialVersionUID = 4346345994166095782;
                _this.initialize();
                return _this;
            }
            ...
            TopCanvas.prototype.drawParticles = function (g) {
                ...
                if (type === DisplayParticleLocPanel.CIRCLE)
                    this.drawCircles(g, size);
                else if (type === DisplayParticleLocPanel.SPHERE)
            ...
            TopCanvas.prototype.calcArcAngle = function (rad, xCent, yCent) {
                var distXPlus = this.d_rveSize - xCent;
                var distYPlus = this.d_rveSize - yCent;
            ...
            return TopCanvas;
        }(DisplayParticleLocPanel.PlaneCanvas));
        DisplayParticleLocPanel.TopCanvas = TopCanvas;
        var SideCanvas = (function (_super) {
            __extends(SideCanvas, _super);
            function SideCanvas(__parent, width, height) {
                var _this = _super.call(this, __parent, width, height, DisplayParticleLocPanel.SIDE) || this;
                Object.defineProperty(_this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler", "java.awt.MenuContainer", "java.awt.image.ImageObserver", "java.io.Serializable"] });
                _this.__parent = __parent;
                _this.serialVersionUID = -5776970808182427859;
                _this.initialize();
                return _this;
            }
        ...
        DisplayParticleLocPanel.SideCanvas = SideCanvas;
        var FrontCanvas = (function (_super) {
            __extends(FrontCanvas, _super);
            function FrontCanvas(__parent, width, height) {
                var _this = _super.call(this, __parent, width, height, DisplayParticleLocPanel.FRONT) || this;
                Object.defineProperty(_this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler", "java.awt.MenuContainer", "java.awt.image.ImageObserver", "java.io.Serializable"] });
                _this.__parent = __parent;
                _this.serialVersionUID = 1971191972767234598;
                _this.initialize();
                return _this;
            }
        ...
        DisplayParticleLocPanel.FrontCanvas = FrontCanvas;
    })(DisplayParticleLocPanel = vaango_ui.DisplayParticleLocPanel || (vaango_ui.DisplayParticleLocPanel = {}));
})(vaango_ui || (vaango_ui = {}));
