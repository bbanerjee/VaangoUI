...
(function (vaango_ui) {
    ...
    var DisplayPartDistPanel = (function (_super) {
        __extends(DisplayPartDistPanel, _super);
        function DisplayPartDistPanel(partSizeDist, parent) {
            ...
            _this.inputCanvas = new DisplayPartDistPanel.DistribCanvas(_this, 3 * canvasWidth, 3 * canvasHeight, _this.INPUT);
            var calcCanvasLabel = new JLabel("Calculated Size Distribution");
            _this.calcCanvas = new DisplayPartDistPanel.DistribCanvas(_this, 3 * canvasWidth, 3 * canvasHeight, _this.CALC);
            var ballCanvasLabel = new JLabel("Calculated Particle Sizes");
            _this.ballCanvas = new DisplayPartDistPanel.BallCanvas(_this, 6 * canvasWidth, canvasHeight);
        ...
        DisplayPartDistPanel.prototype.setParticleSizeDist = function (ps) {
            this.d_partSizeDist = ps;
        };
        DisplayPartDistPanel.prototype.refresh = function () {
            this.inputCanvas.refresh();
            this.calcCanvas.refresh();
            this.ballCanvas.refresh();
        };
        return DisplayPartDistPanel;
    }(JPanel));
    /**
     *
     */
    DisplayPartDistPanel.serialVersionUID = -3857472260211697750;
    vaango_ui.DisplayPartDistPanel = DisplayPartDistPanel;
    (function (DisplayPartDistPanel) {
        var DistribCanvas = (function (_super) {
            ...
            function DistribCanvas(__parent, width, height, flag) {
                ...
                _this.serialVersionUID = 1499076092071613264;
                _this.xbuf = 0;
                _this.ybuf = 0;
                _this.xsmallbuf = 0;
                _this.ysmallbuf = 0;
        ...
        DisplayPartDistPanel.DistribCanvas = DistribCanvas;
        var BallCanvas = (function (_super) {
            ...
            function BallCanvas(__parent, width, height) {
                ...
                Object.defineProperty(_this, '__interfaces', { configurable: true, value: ["javax.swing.TransferHandler.HasGetTransferHandler", "java.awt.MenuContainer", "java.awt.image.ImageObserver", "java.io.Serializable"] });
                _this.__parent = __parent;
                _this.serialVersionUID = -8031713824337460367;
        ...
        DisplayPartDistPanel.BallCanvas = BallCanvas;
    })(DisplayPartDistPanel = vaango_ui.DisplayPartDistPanel || (vaango_ui.DisplayPartDistPanel = {}));
})(vaango_ui || (vaango_ui = {}));
