...
var vaango_ui;
(function (vaango_ui) {
    var CompNeoHookMaterialPanel = (function (_super) {
        __extends(CompNeoHookMaterialPanel, _super);
        function CompNeoHookMaterialPanel() {
         ...
         */
        CompNeoHookMaterialPanel.prototype.writeUintah = function (pw, tab) {
            if (pw == null)
                return;
        ...
        return CompNeoHookMaterialPanel;
    }(JPanel));
    /**
     *
     */
    CompNeoHookMaterialPanel.serialVersionUID = -3786552153135985203;
    vaango_ui.CompNeoHookMaterialPanel = CompNeoHookMaterialPanel;
})(vaango_ui || (vaango_ui = {}));
